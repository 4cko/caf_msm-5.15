 ...
 *
 * Ported & Cleaned up for Linux 5.15 compatibility.
 */
...
void register_power_suspend(struct power_suspend *handler)
{
    ...
    /* Cleaned up redundant loop: list_add_tail already appends to the end */
...
static const struct attribute_group power_suspend_attr_group =
{
